...
class WRMSSEEvaluator(object):
    ...
    def __init__(self,
        ...
        # self.prices = prices
        self.prices = pd.read_csv(utils.DATA_DIR / 'sell_prices.csv')
...
#         self.calendar = None
    ...
    def get_name(self, i):
        ...
        '''
        if type(i) == str or type(i) == int or type(i) == np.int64:
    ...
    def get_weight_df(self) -> pd.DataFrame:
        ...
        # print(weight_df[["item_id", "store_id", "wm_yr_wk"]].dtypes)
        # print(prices[["item_id", "store_id", "wm_yr_wk"]].dtypes)
...
#         print(weight_df)
        ...
        for i, group_id in enumerate(tqdm(self.group_ids, leave=False)):
            lv_weight = weight_df.groupby(
                group_id)[self.weight_columns].sum().sum(axis=1)
    ...
    def trans_30490_to_42840(self, df, cols, group_ids, dis=True):
        '''
    ...
    def score(self, valid_preds: Union[pd.DataFrame, np.ndarray]) -> float:
        ...
        if isinstance(valid_preds, np.ndarray):
            valid_preds = pd.DataFrame(
                valid_preds, columns=self.valid_target_columns)
